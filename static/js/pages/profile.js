        ...
        LoadReplay(id, mods) {
            ...
            vm.$axios.get(window.location.protocol + "//" + window.location.hostname + ":" + window.location.port + "/api/get_replay",
                ...
                .then(function (response) {
                    ...
                    document.getElementById('contentmodal').innerHTML = "<div class='score-beatmap'><h1 class='score-beatmap-title'><a class='score-beatmap-linkplain'>" + replaydata.artist + " - " + replaydata.title + " [" + replaydata.version + "] + "+replaydata.mods_readable +"</a></h1></div><div class='score-info'><div class='infoitem infoitem-player'><div class='score-player'><div class='score-player-row--score'> <div class='score-player-score'>" + replaydata.score + "</div></div><div class='score-player-row--player'><span>Played by</span><strong>" + replaydata.name + "</strong><span>Submitted</span><strong>" + replaydata.play_time + "</strong></div></div></div><div class='infoitem infoitem--dial'> <div class='score-dial'> <div class='score-dial-layer--grade'><span>" + replaydata.grade + "</span></div></div></div></div><div class='score-stats'> <div class='score-stats-group score-stats-group--stats'> <div class='score-stats-group-row'> <div class='score-stats-stat'> <div class='score-stats-stat-row--label'>Accuracy</div><div class='score-stats-stat-row'>" + replaydata.acc + "%</div></div><div class='score-stats-stat'> <div class='score-stats-stat-row--label'>Max Combo</div><div class='score-stats-stat-row'>" + replaydata.max_combo + "x</div></div><div class='score-stats-stat'> <div class='score-stats-stat-row--label'>pp</div><div class='score-stats-stat-row'><span>" + replaydata.pp.toFixed() + "</span></div></div></div><div class='score-stats-group-row'> <div class='score-stats-stat'> <div class='score-stats-stat-row--label'>300</div><div class='score-stats-stat-row'>" + replaydata.n300 + "</div></div><div class='score-stats-stat'> <div class='score-stats-stat-row--label'>100</div><div class='score-stats-stat-row'>" + replaydata.n100 + "</div></div><div class='score-stats-stat'> <div class='score-stats-stat-row--label'>50</div><div class='score-stats-stat-row'>" + replaydata.n50 + "</div></div><div class='score-stats-stat'> <div class='score-stats-stat-row--label'>miss</div><div class='score-stats-stat-row'>" + replaydata.nmiss + "</div></div></div></div></div>"
                });
        },
