...
} else if ($account->isAuthenticated() && !($account->getPrivileges() & Privileges::ManageBeatmaps)) {
    $_SESSION["msg"] = array(
        "type" => "danger",
...
<html>
  <head>
    <!-- Title -->
    <title><?= $config->instanceName ?> - Admin - Beatmap Management</title>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col mt-1 mb-1 pt-3 pb-5 pl-5 pr-5 bg-dark text-white">
          <h3>Beatmap Management</h3>
          <p>This is the <b>Beatmap Management</b> page! Here you can manage everything about beatmaps!</p>
          <hr/>
          <div>
              TODO
          </div>
